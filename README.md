...
<p align="center">
  <a href="https://github.com/dulanjayabhanu?tab=repositories">
    <img src="https://skillicons.dev/icons?i=html,css,javascript,bootstrap,materialui,tailwind,sass,php,mysql,jquery,typescript,react,npm,maven,mongodb,nodejs,git,github,gitlab,java,hibernate,gcp,linux,ubuntu,bash,powershell,cloudflare,postman,netlify,vercel,wordpress,python,blender,arduino,notion,vscode,idea,androidstudio,pycharm,visualstudio,photoshop,ai,figma,pr,au,payara" />
  </a>
</p>
